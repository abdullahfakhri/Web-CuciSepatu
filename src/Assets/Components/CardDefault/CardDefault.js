  ...
  return (
    <div className="container-allCard">
      <div>
        ...
        <hr className="box2"/>
        <p className="textService">Wrap your Shoes sudah mencuci lebih dari 643 pasang sepatu dan akan terus bertambah. Untuk service atau layanan anda bisa melihat dibawah ini</p>
      </div>
        ...
        <div className="card1">
          <Card style={{ width: "18rem" }}>
            ...
            <Card.Body>
              ...
              <Card.Text>
                reguler adalah jasa cuci sepatu sencara menyeluruh agar sepatuh
        ...
        <div className="card2">
          <Card style={{ width: "18rem" }}>
            ...
            <Card.Body style={{ width: "18rem" }}>
              ...
              <Card.Text>
                Deep cleaning adalah jasa mcuci sepatu secara menyeluruh, mulai
                dari bagian luar hingga dalam. Dan juga jika terdapat yellowing
                atau noda lainnya dapat di bersihkan.
              </Card.Text>
            </Card.Body>
          </Card>
        </div>
        <div className="card3">
          <Card style={{ width: "18rem" }}>
            ...
            <Card.Body>
              ...
              <Card.Text>
                One day service adalah jasa cuci sepatu yang bisa diselesaikan
                pada hari itu juga.
              </Card.Text>
            </Card.Body>
          </Card>
